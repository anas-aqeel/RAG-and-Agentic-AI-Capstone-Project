...
This exercise builds a CLI for CRUD operations on structured restaurant data.
It reuses the LLM functions from Exercise 1 to process new entries.

Usage:
    1. pip install -r requirements.txt
    2. gcloud auth application-default login
    3. Ensure .env exists at project root with GCP_PROJECT_ID
    4. Place structured_restaurant_data.json in this directory (from Exercise 1)
    5. python restaurant_data_management.py
"""
...
# =============================================================================
# Exercise 1: Integrate LLM from Lesson 1
# =============================================================================
